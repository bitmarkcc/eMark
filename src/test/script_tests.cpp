...
static const unsigned int flags = 0;
 ...
 static std::map<string, unsigned int> mapFlagNames = boost::assign::map_list_of
   ...
   (string("P2SH"), (unsigned int)SCRIPT_VERIFY_NONE)
   (string("STRICTENC"), (unsigned int)SCRIPT_VERIFY_NONE)
   (string("DERSIG"), (unsigned int)SCRIPT_VERIFY_NONE)
   (string("LOW_S"), (unsigned int)SCRIPT_VERIFY_NONE)
